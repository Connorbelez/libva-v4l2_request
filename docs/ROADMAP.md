...
- [iconidentify/libva-v4l2_request#21](https://github.com/iconidentify/libva-v4l2_request/issues/21) — Make conformance results schema-validated and compare exact passing vectors (P0, M0). Comparator: `python3 tests/compare-results.py`.
